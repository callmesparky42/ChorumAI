        ...
        <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <img src="/logo.png" alt="Chorum AI" className="h-12 mx-auto mb-4" />
                    <h1 className="text-2xl font-bold text-white">Welcome to Chorum AI</h1>
                    <p className="text-gray-400 mt-2">The intelligent LLM router that saves you money</p>
                </div>

                {/* Login Card */}
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
                    <h2 className="text-lg font-medium text-white mb-6 text-center">Sign in to continue</h2>
