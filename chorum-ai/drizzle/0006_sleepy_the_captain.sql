ALTER TABLE "memory_summaries" DROP CONSTRAINT "memory_summaries_project_id_projects_id_fk";
--> statement-breakpoint
ALTER TABLE "messages" DROP CONSTRAINT "messages_project_id_projects_id_fk";
--> statement-breakpoint
ALTER TABLE "routing_log" DROP CONSTRAINT "routing_log_project_id_projects_id_fk";
--> statement-breakpoint
