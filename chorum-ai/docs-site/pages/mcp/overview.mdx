...
| Use Case | Web UI | MCP |
|----------|--------|-----|
| Standalone chat with memory dashboard | ✅ | ❌ |
| Memory for Cursor/Claude Code/Windsurf | ⚠️ manual | ✅ automatic |
| Peer review across providers | ✅ | ❌ |
| Cost tracking & budgets | ✅ | ❌ |
| Review/approve learnings | ✅ | via web |
| Just want memory in existing tools | ❌ | ✅ |

**Recommendation:** Use both. MCP for day-to-day coding in your IDE, web UI for reviewing memory and managing learnings.

> **New to Chorum?** Start with the [5-Minute Setup](./quickstart) to get MCP running in your IDE.
